...
--
-- Host: 127.0.0.1
-- Czas generowania: 25 Wrz 2020, 07:44
...
CREATE TABLE `noworodki` (
  `id_noworodka` int(11) NOT NULL,
  `plec` enum('c','s') DEFAULT NULL,
  `imie` varchar(30) NOT NULL,
...
INSERT INTO `noworodki` (`id_noworodka`, `plec`, `imie`, `data urodzenia`, `waga`, `wzrost`, `id_mamy`) VALUES
...
ALTER TABLE `noworodki`
  ADD PRIMARY KEY (`id_noworodka`),
  ADD KEY `id_mamy` (`id_mamy`);
...
--
ALTER TABLE `noworodki`
  MODIFY `id_noworodka` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=181;
...
--
ALTER TABLE `noworodki`
  ADD CONSTRAINT `noworodki_ibfk_1` FOREIGN KEY (`id_mamy`) REFERENCES `mamy` (`id_mamy`);
COMMIT;
