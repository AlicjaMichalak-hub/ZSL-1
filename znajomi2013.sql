...
--
-- Host: 127.0.0.1
-- Czas generowania: 01 Paź 2020, 15:37
...
CREATE TABLE `hobby` (
  `Id_hobby` char(4) COLLATE utf8mb4_polish_ci NOT NULL,
  `Hobby` varchar(30) COLLATE utf8mb4_polish_ci NOT NULL
...
CREATE TABLE `ma_hobby` (
  `Id` int(11) NOT NULL,
  `Id_osoba` char(4) COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `Id_hobby` char(4) COLLATE utf8mb4_polish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;
...
CREATE TABLE `osoby` (
  `Id_osoba` char(4) COLLATE utf8mb4_polish_ci NOT NULL,
...
--
ALTER TABLE `ma_hobby`
  ADD CONSTRAINT `ma_hobby_ibfk_1` FOREIGN KEY (`Id_hobby`) REFERENCES `hobby` (`Id_hobby`),
  ADD CONSTRAINT `ma_hobby_ibfk_2` FOREIGN KEY (`Id_osoba`) REFERENCES `osoby` (`Id_osoba`);
COMMIT;
